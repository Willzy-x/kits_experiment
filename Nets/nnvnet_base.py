...
class VNet(nn.Module):
    ...
    def __init__(self, elu, nll=False, attention='DcpA', nclass=3):
        super(VNet, self).__init__()
        # self.isStart = False # ver. 4
        self.in_tr = InputTransition(30) # 16
        self.down_tr30 = DownTransition(30, 60, 1) # 16
        ...
        self.down_tr320 = DownTransition(320, 320, 5)
        # if attention == 'DbA':
        ...
        self.up_tr30 = UpTransition(60, 30)
        self.out_tr = OutputTransition(30, nclass=nclass, nll=nll) # 32
