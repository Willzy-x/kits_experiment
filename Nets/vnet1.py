...
class OutputTransition(nn.Module):
    def __init__(self, inChans, nclass, elu, nll):
        ...
        self.dcpa = DecoupledAttention3d(inChans, nclass)
        '''
        if nll:
    ...
    def forward(self, x):
        ...
        out = self.relu1(self.bn1(self.dcpa(x)))
        out = self.conv2(out)
...
class VNet(nn.Module):
    ...
    def __init__(self, elu=True, nll=False, attention='DcpA'):
        ...
        # self.out_tr = DecoupledAttention3d(32, 2)
        # self.out_final = nn.Conv3d(2,2, kernel_size=1)
