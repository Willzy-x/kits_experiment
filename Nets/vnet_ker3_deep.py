...
class VNet(nn.Module):
    ...
    def __init__(self, nclass=2, elu=True, nll=False, attention='DcpA'):
        ...
        self.c1 = SupervisionTransition(256, nclass, nll=nll)
        self.c2 = SupervisionTransition(128, nclass, nll=nll)
        self.c3 = SupervisionTransition(64, nclass, nll=nll)
        self.c4 = SupervisionTransition(32, nclass, nll=nll)
    ...
    def forward(self, x):
        ...
        out_list.append(self.out_tr(out))
        return out_list
